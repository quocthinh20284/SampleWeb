...
<body style="background-color: deepskyblue">
    ...
    <div class="page">
          ...
          <%-- <section class="well">--%>            <%--<div class="container">--%>
                <h4><em>Welcome to Online Food Ordering System</em></h4>
          <%-- </div>     --%>       <%-- </section>--%>
        <section class="well well__offset-1 bg-1" style="background-color: deepskyblue">
         <div class="container">
         </div>
            <div id="login">
                <table class="tbl">
                    <tr>
                        <td colspan="2" height="30" 
                            style="border-bottom: thin solid #FFFFFF; color: #000; font-weight: 700; text-align: center;" 
                            valign="middle">
                            ADMIN LOGIN</td>
                    </tr>
                    <tr>
